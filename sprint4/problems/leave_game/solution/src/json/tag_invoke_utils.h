...
struct LootKey{
    ...
    constexpr const static boost::json::string_view SCORE                = "score";
};
...
struct UserKey {
    ...
    constexpr const static boost::json::string_view RETIREMENT_TIME      = "dogRetirementTime";
};
...
struct DataBaseKey {
    ...
    constexpr const static boost::json::string_view NAME                 = "name";
    constexpr const static boost::json::string_view SCORE                = "score";
    constexpr const static boost::json::string_view PLAY_TIME            = "playTime";
};
