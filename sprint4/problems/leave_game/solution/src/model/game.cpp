...
/**
 * Получить максимальное время бездействия пса.
 * Время бездействия пса — непрерывный промежуток времени, в течение которого скорость пса была равна нулю.
 * Бездействие пса начинается при наступлении любого из следующих условий:
 * - Пёс получил команду {"move": ""}
 * - Пёс остановился, упёршись в край дороги
 * По окончании этого времени игрок будет исключён из комнаты, а его результаты будут занесены в таблицу результатов.
 * @return время бездействия
 */
...
/**
 * Задать время бездействия пса
 * @param retirement_time время бездействия
 */
