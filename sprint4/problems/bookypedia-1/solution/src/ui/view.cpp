...
namespace ui {
    ...
    bool View::AddAuthor(std::istream& cmd_input) const {
        try {
            ...
            if (name.empty()){
                throw std::logic_error("name author is empty");
            }
    ...
    bool View::ShowAuthorBooks() const {
        try {
            if (auto author_id = SelectAuthor(); author_id.has_value()) {
    ...
    ui::detail::BooksInfo View::GetBooks() const {
        return use_cases_.GetBooksInfo();
    }

    ui::detail::BooksInfo View::GetAuthorBooks(const std::string& author_id) const {
        return use_cases_.GetAuthorBooksInfo(author_id);
    }
