...
private:
    ...
    [[nodiscard]] bool IsKilledInDirection(size_t x, size_t y, int dx, int dy) const {
...
public:
    ...
    [[nodiscard]] bool IsKilled(size_t x, size_t y) const {
...
private:
    ...
    [[nodiscard]] State Get(size_t x, size_t y) const {
        return field_[x + y * field_size];
    }
